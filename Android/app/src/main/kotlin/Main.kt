...
internal val logger: SkipLogger = SkipLogger(subsystem = "skip.todo", category = "SkipTodo")

private typealias AppRootView = SkipTodoRootView
private typealias AppDelegate = SkipTodoAppDelegate
